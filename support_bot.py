...
print("=" * 50)
print("SUPPORT BOT - ENVIRONMENT VARIABLES CHECK:")
...
# Define states
SELECT_LANG, MAIN_MENU, SUPPORT_FLOW, USERNAME_COLLECTION = range(4)
...
STRINGS = {
    'en': {
        ...
        'welcome': "🆘 Welcome to Support! Let's troubleshoot your issues and get you back to earning rewards.",
        'helpful_channel_btn': "Full guide in channel",
        'support_btn': "Start Support Session",
    ...
    'fr': {
        ...
        'welcome': "🆘 Bienvenue au Support ! Déboguons vos problèmes et remettons-vous sur la voie des récompenses.",
        'helpful_channel_btn': "Guide complet sur le canal",
        'support_btn': "Démarrer la Session de Support",
...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE, message: str = None):
    ...
    keyboard = [
        [InlineKeyboardButton("🆘 Start Support Session", callback_data="support_start")],
...
async def collect_username(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if username.startswith('@') and len(username) > 2:
        logger.info(f"*** SUPPORT - USERNAME COLLECTION from user {update.message.from_user.id}: {username} ***")
